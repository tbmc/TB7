...
//LexemChaine lexemCreerDefaut();
//LexemChaine lexemCreer(TypeLexem type, float value);
//void lexemLiberer(LexemChaine lexem);
//LexemChaine lexemAdd(LexemChaine lexem, TypeLexem type, float value);
//LexemChaine lexemInserer(LexemChaine lexem, int idx, TypeLexem type, float value);
